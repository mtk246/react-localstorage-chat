...
return new class() extends Migration {
    public function up(): void
    {
        ...
        CREATE OR REPLACE VIEW public.view_detailed_patient AS 
            SELECT
                ...
                CASE
                    WHEN claim_demographic.id > 0 THEN 1
                    ELSE 0
                ...
                concat(
                    ...
                    COALESCE(
                        CASE
                            WHEN type_catalogs.code != '' THEN concat(' ', type_catalogs.code)
                            ELSE null
                        END,
                        '':: character varying
                    ),
