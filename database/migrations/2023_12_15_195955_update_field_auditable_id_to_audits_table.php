...
return new class() extends Migration {
    ...
    {
        DB::statement('DROP VIEW  IF EXISTS view_user_productivity');
        DB::statement('DROP VIEW  IF EXISTS view_claims_status_monitoring');
        DB::statement('ALTER TABLE audits ALTER COLUMN auditable_id TYPE VARCHAR(255)');
        DB::unprepared("
            ...
            ) AS first_audits ON CAST(claims.id AS text) = CAST(first_audits.auditable_id AS text)
