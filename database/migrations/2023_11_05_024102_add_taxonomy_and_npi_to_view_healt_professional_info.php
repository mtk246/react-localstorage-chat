...
return new class() extends Migration {
    ...
    {
        DB::unprepared("
            DROP VIEW IF EXISTS view_health_professional_information;
            ...
            SELECT
                ...
                health_professionals.upin as upin,
                health_professionals.ein as ein,
                (
                    CASE
                ...
                health_professional_taxonomy.primary as primary_taxonomy
            ...
            LEFT JOIN health_professional_taxonomy ON health_professionals.id = health_professional_taxonomy.health_professional_id
            LEFT JOIN taxonomies ON health_professional_taxonomy.taxonomy_id = taxonomies.id
            ...
            WHERE contacts.contactable_type = 'App\Models\Profile'
                ...
                AND health_professional_taxonomy.billing_company_id = billing_companies.id
        ");
    }
