...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            [
                'name' => 'View Claim Rules',
                'slug' => 'claimrule.view',
                'module' => 'Claim Rules Management',
                'constraint' => '',
                'description' => 'View Claim Rules',
            ],
            [
                'name' => 'Create Claim Rules',
                'slug' => 'claimrule.create',
                'module' => 'Claim Rules Management',
                'constraint' => 'claimrule.view',
                'description' => 'Create Claim Rules',
            ],
            [
                'name' => 'Show Claim',
                'slug' => 'claimrule.show',
                'module' => 'Claim Rules Management',
                'constraint' => 'claimrule.view',
                'description' => 'Show Claim Rules',
            ],
            [
                'name' => 'Edit Claim Rules',
                'slug' => 'claimrule.edit',
                'module' => 'Claim Rules Management',
                'constraint' => 'claimrule.show',
                'description' => 'Edit Claim Rules',
            ],
            [
                'name' => 'Disable Claim Rules',
                'slug' => 'claimrule.disable',
                'module' => 'Claim Rules Management',
                'constraint' => 'claimrule.show',
                'description' => 'Disable Claim Rules',
            ],
            [
                'name' => 'View a Claim Rules Change History',
                'slug' => 'claimrule.history',
                'module' => 'Claim Rules Management',
                'constraint' => 'claimrule.show',
                'description' => 'View a Claim Rules Change History',
            ],
        ];
