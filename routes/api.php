...
->middleware(['restrictIpAddress', 'lastActivity'])->group(function() {
    ...
    Route::prefix("billing-company")->group(function(){
        Route::get("/get-server-all",[\App\Http\Controllers\BillingCompanyController::class,'getServerAllBillingCompanies'])->middleware(['auth:api']);
        Route::post("create",
    ...
    Route::prefix("patient")->middleware([
        ...
        Route::patch("/add-policies-to-patient/{id}",[\App\Http\Controllers\PatientController::class,'addPolicies']);
