...
class PatientRepository
{
    ...
    public function getPolicy(int $insurance_policy_id, int $patient_id)
    {
        ...
        $record = [
            ...
            'insurance_plan_nickname' => $insurancePolicy->insurancePlan->nicknames()?->where('billing_company_id', $patient_policy->billing_company_id)?->nickname ?? '',
    ...
    public function getPolicies(Request $request, int $patient_id)
    {
        ...
        $data->getCollection()->transform(fn ($policy) => [
            ...
            'insurance_plan_nickname' => $policy->insurancePlan->nicknames()?->where('billing_company_id', $patient_policy->billing_company_id)?->nickname ?? '',
