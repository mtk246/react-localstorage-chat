...
enum RadiologyType: int implements ProcedureClassificationInterface
{
    ...
    #[NameAttribute('Diagnostic Radiology (Diagnostic Imaging) Diagnoses')]
    #[RangeAttribute('70010', '76499')]
    #[PublicAttribute(true)]
    case DIACNOSTIC_IMAGING = 1;

    #[NameAttribute('Diagnostic Ultrasound Diagnoses')]
    ...
    #[NameAttribute('Nuclear Medicine Diagnoses')]
    #[RangeAttribute('78012', '79999')]
    #[PublicAttribute(true)]
    case NUCLEAR_MEDICINE_Diagnoses = 7;
}
