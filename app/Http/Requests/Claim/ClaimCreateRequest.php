...
class ClaimCreateRequest extends FormRequest
{
    ...
    protected function getUB04Rules($insuredField)
    {
        return [
            ...
            'health_professional_qualifier.*.field_id' => ['required', 'integer'],
            ...
            'additional_information.admisison_date' => ['sometimes', 'date'],
            'additional_information.admisison_time' => ['nullable', 'date_format:H:i'],
            'additional_information.discharge_date' => ['sometimes', 'date'],
            'additional_information.discharge_time' => ['sometimes', 'date_format:H:i'],
            'additional_information.condition_codes' => ['nullable', 'array'],
            'additional_information.admisison_type_id' => ['required', 'integer'],
            'additional_information.admisison_source_id' => ['required', 'integer'],
