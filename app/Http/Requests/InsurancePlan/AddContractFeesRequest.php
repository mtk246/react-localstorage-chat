...
class AddContractFeesRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'contract_fees.*.price' => ['nullable', 'prohibited_if:contract_fees.*.price_percentage', 'numeric'],
            ...
            'contract_fees.*.price_percentage' => ['nullable', 'prohibited_if:contract_fees.*.price', 'numeric'],
