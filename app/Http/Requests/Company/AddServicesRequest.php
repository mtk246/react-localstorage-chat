...
final class AddServicesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'services.*.procedure_ids' => ['nullable', 'array', 'required_without:services.*.revenue_code_id'],
            'services.*.revenue_code_id' => ['nullable', 'integer', 'required_without:services.*.procedure_ids'],
