...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'subscriber.address.address' => ['sometimes', 'required_if:own_insurance,false', 'string'],
            'subscriber.address.country' => ['sometimes', 'required_if:own_insurance,false', 'string'],
